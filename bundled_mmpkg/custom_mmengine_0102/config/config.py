...
from custom_mmengine_0102.fileio import dump, load
from custom_mmengine_0102.logging import print_log
from custom_mmengine_0102.utils import (check_file_exist, digit_version,
                ...
                if level > 0:
                    ...
                    if len(module_list) == 1:
                        raise ConfigParsingError(
                            ...
                            'is an example: '
                            '`with read_base(): from custom_mmdet_330.configs.retinanet_r50_fpn_1x_coco import *`'  # noqa: E501
                        )
                    else:
