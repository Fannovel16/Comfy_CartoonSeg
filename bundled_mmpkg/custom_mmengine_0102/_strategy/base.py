...
from custom_mmengine_0102.optim import (BaseOptimWrapper, OptimWrapperDict,
                            _ParamScheduler, build_optim_wrapper)
from custom_mmengine_0102.registry import MODELS, OPTIM_WRAPPERS, PARAM_SCHEDULERS
...
class BaseStrategy(metaclass=ABCMeta):
    ...
    def _set_randomness(
        ...
        Args:
            ...
            deterministic (bool): Whether to set the deterministic option for
                ...
                more details.
        """
        from custom_mmengine_0102.runner import set_random_seed
    ...
    def model_state_dict(self) -> dict:
        ...
        from custom_mmengine_0102.runner import weights_to_cpu
    ...
    def load_or_resume(
        ...
        *,
        ...
        """
        from custom_mmengine_0102.runner import find_latest_checkpoint
