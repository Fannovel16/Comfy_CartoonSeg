...
from custom_mmengine_0102.model import BaseDataPreprocessor, is_model_wrapper
from custom_mmengine_0102.optim import (AmpOptimWrapper, BaseOptimWrapper, OptimWrapper,
                            OptimWrapperDict, _ParamScheduler,
                            build_optim_wrapper)
from custom_mmengine_0102.registry import (FUNCTIONS, MODEL_WRAPPERS, OPTIM_WRAPPERS,
                               PARAM_SCHEDULERS, STRATEGIES, Registry)
from custom_mmengine_0102.utils import get_git_hash, mkdir_or_exist
    ...
    def save_checkpoint(self,
        ...
        Keyword Args:
            ...
            callback (callable, callable): Callback function to modify the
                ...
                Defaults to None.
        """
        from custom_mmengine_0102.runner.checkpoint import save_checkpoint
