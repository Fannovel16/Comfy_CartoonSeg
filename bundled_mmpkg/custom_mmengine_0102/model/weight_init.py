...
from custom_mmengine_0102.registry import WEIGHT_INITIALIZERS, build_from_cfg
...
class PretrainedInit:
    ...
    def __call__(self, module):
        from custom_mmengine_0102.runner.checkpoint import (_load_checkpoint_with_prefix,
                                                load_checkpoint,
                                                load_state_dict)
