...
from custom_mmengine_0102.device import is_npu_available, is_npu_support_full_precision
from custom_mmengine_0102.registry import OPTIM_WRAPPER_CONSTRUCTORS, OPTIMIZERS
