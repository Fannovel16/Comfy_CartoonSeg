...
from custom_mmengine_0102.config.utils import MODULE2PACKAGE
from custom_mmengine_0102.utils import get_object_from_string, is_seq_of
...
class Registry:
    ...
    def switch_scope_and_registry(self, scope: Optional[str]) -> Generator:
        ...
        Examples:
            >>> from custom_mmengine_0102.registry import Registry, DefaultScope, MODELS
            >>> import time
            >>> # External Registry
    ...
    def build(self, cfg: dict, *args, **kwargs) -> Any:
        ...
        Examples:
            >>> from custom_mmengine_0102 import Registry
            >>> MODELS = Registry('models')
            >>> @MODELS.register_module()
            >>> class ResNet:
