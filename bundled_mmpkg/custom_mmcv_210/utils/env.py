...
import torch
from custom_mmengine_0102.utils.dl_utils import collect_env as mmengine_collect_env
...
def collect_env():
    ...
    try:
        from custom_mmcv_210.ops import get_compiler_version, get_compiling_cuda_version
