...
from custom_mmengine_0102.utils import deprecated_api_warning, to_2tuple

from custom_mmcv_210.cnn import (Linear, build_activation_layer, build_conv_layer,
                      build_norm_layer)
...
try:
    from custom_mmcv_210.ops.multi_scale_deform_attn import \
        MultiScaleDeformableAttention  # noqa F401
    warnings.warn(
        ImportWarning(
            '``MultiScaleDeformableAttention`` has been moved to '
            '``mmcv.ops.multi_scale_deform_attn``, please change original path '  # noqa E501
            '``from custom_mmcv_210.cnn.bricks.transformer import MultiScaleDeformableAttention`` '  # noqa E501
            'to ``from custom_mmcv_210.ops.multi_scale_deform_attn import MultiScaleDeformableAttention`` '  # noqa E501
        ))
